...
#     create_time = models.DateTimeField(verbose_name="创建时间", auto_now_add=True)
#     article = models.ForeignKey(verbose_name="对应文章", to="Article", on_delete=models.CASCADE)
#     sender = models.ForeignKey(verbose_name="发送者", to="User", on_delete=models.CASCADE)


# class SecondComment(models.Model):
#     content = models.CharField(verbose_name="内容", max_length=300)
#     create_time = models.DateTimeField(verbose_name="创建时间", auto_now_add=True)
#     receiver = models.ForeignKey(verbose_name="接收者", to="User",
#                                  on_delete=models.CASCADE, related_name="second_comment_receiver")
#     sender = models.ForeignKey(verbose_name="发送者", to="User",
#                                on_delete=models.CASCADE, related_name="second_comment_sender")
#
