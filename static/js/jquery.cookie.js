            ...
            success: function (res) {
                ...
                if (res.code == 0) {
                    ...
                    $.each(data, function (i, obj) {
                        ...
                        // console.log(obj);
                        var str = '';
                        str+='<a href="/shopping/detail/?id='+obj.id+'" target="_blank">查看详情↑</a>'
                        str += '<li class="campusGroup_' + obj.campusGroup + ' details"><a href="/shopping/detail/?id=' + obj.id + '" >' + '<div class="row" > <div class="col-xs-3"> <img width="100%" src="' + obj.avatar + '" alt=""><br> <p class="tac"> id <br>' + obj.id + '</p> <p class="tac">' + '</p></div> <div class="col-xs-9"> <h4> 用户: ' + obj.userName + '<span class="spanright">' + obj.c_time + '</span></h4><h4 class="articletitle"> ' + obj.content + '</h4><p class=".articlecontent"> </p> <p> <span> 评论: ' + obj.commentNum + ' </span> <span class="spanright"> 最近动态:' + obj.comment_time + '</span></p><p><span> 浏览:' + obj.watchNum + '</span><span class="spanright"> 喜欢:' + obj.likeNum + '</span></p> <span> radioGroup: ' + obj.radioGroup + '</span> </div> </div></a></li>';
                        $("#xiaoyuanqiangdatacontent").append(str);
                    });
                    $("#pagedividerstring").show()
                } else {
                    var str = "<h1><p> " + res.message + " </p></h1>"
                    $("#xiaoyuanqiangdatacontent").append(str);
                }
            },
            error: function (arg1) {
